...
class HomeViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var shelters = [
        Shelter(id: "1", name: "Bournemouth Borough Council Housing Services", bio: "Assessment of entitlement to housing for people who are homeless or threatened with homelessness. Housing for people considered in priority need of housing. Temporary accommodation may be available while enquiries are made about eligibility. Homelessness prevention work. Rent deposit scheme. General housing advice and information. Out of hours emergencies phone 01202 668123.", address: "Town Hall St Stephen's Road Bournemouth BH2 6LL United Kingdom", long: -1.882, lat: 50.722, website: "www.bournemouth.gov.uk", target: 10),
        Shelter(id: "2", name: "BCHA Dorset Lodge", bio: "Single homeless people. Can accommodate ex-offenders. Must have local connection to Bournemouth.", address: "Town Hall St Stephen's Road Bournemouth BH2 6LL United Kingdom", long: 1.888, lat: 50.721, website: "www.bournemouth.gov.uk", target: 10),
        Shelter(id: "3", name: "BCHA St Paul's Hostels", bio: "Single homeless people with a local connection to Bournemouth. Those without a local connection can only stay if local authority grant temporary permission. Short stay agreement up to 6th months, and can be extended, Can accept 2 couples. Can accept people with dogs.", address: "Town Hall St Stephen's Road Bournemouth BH2 6LL United Kingdom", long: -1.866, lat: 50.725, website: "www.bournemouth.gov.uk", target: 15),
    ]
